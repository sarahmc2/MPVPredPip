file1=open("./iedb_btcells_consensus.txt").readlines()
sudan=open("../sudan.fasta").readlines()
zaire=open("../zaire.fasta").readlines()
output1=open("./iedb_btcells_consensus_table.txt", "w")


output1.write("Epitope No.\tB-cell and T-Cell consensus epitope sequence\tLength\tResidue Position Sudan\tResidue Position Zaire\n")
