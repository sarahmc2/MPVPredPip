...
output1.write("Epitope No.\tConsensus Sudan and Zaire T-cell sequences of MHC-I and MHC-II consensus epitope sequences\tLength\tResidue Position Sudan\tResidue Position Zaire\n")
